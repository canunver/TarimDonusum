...
public sealed class RPROB_Istihdam(string uygulamaRootPath):RPROBTemel(uygulamaRootPath)
{
    ...
    protected override void Doldur(Tablo t,Basvuru b)
    {
        ...
        BasvuruUygulamaAdresi? adres=b.YatirimAdresleri.OrderBy(x=>x.siraNo).FirstOrDefault();t.HucreDegerYaz(4,2,adres?.ilAdi??b.basvuruFirma.il.ad);t.HucreDegerYaz(4,6,adres?.ilceAdi??"");t.HucreDegerYaz(4,10,b.HesaplananTalepEdilenFinansmanTutari.GetValueOrDefault());
        ...
        IstihdamHesapSonucu h=IstihdamHesaplayici.Hesapla(i,b.HesaplananTalepEdilenFinansmanTutari.GetValueOrDefault());
